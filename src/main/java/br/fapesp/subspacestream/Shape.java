...
public abstract class Shape {
	 ...
	 */
	private static final double EXTRA_SEP = 15;
	 ...
	 * min radius value
	 */
	private static final double MIN_R = 5; //0.05;
	
	/**
	 * max radius value
	 */
	private static final double MAX_R = 6; //0.2;
	 ...
	 */
	private static final double MAX_V = 250; //1.0;
